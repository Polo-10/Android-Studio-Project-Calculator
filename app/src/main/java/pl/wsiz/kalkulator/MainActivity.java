        ...
        if ((specialFunction == null && sign == null) || (input.getText().equals(""))) {
            ...
            switch (specialFunction) {
                ...
                case "sin":
                    ...
                    double radiansSin = Math.toRadians(num1);
                    input.setText(Math.sin(radiansSin) + "");
                ...
                case "cos":
                    value1 = input.getText().toString();
                    num1 = Double.parseDouble((value1));
                    double radiansCos = Math.toRadians(num1);
                    input.setText(Math.cos(radiansCos) + "");
                    specialFunction = null;
                    signBox.setText(null);
                    break;
                case "tan":
                    value1 = input.getText().toString();
                    num1 = Double.parseDouble((value1));
                    double radiansTan = Math.toRadians(num1);
                    input.setText(Math.tan(radiansTan) + "");
                    specialFunction = null;
                    isSpecialFunctionOn = false;
                    signBox.setText(null);
                    break;
